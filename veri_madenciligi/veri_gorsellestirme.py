...
sns.histplot(data=veri,x="yas",hue="kalp_rahatsizligi",element="step",palette="BuPu")
plt.xlabel("yaş")
plt.ylabel("Adet")
plt.title("Yaş verisi histogramı")
plt.show()
...
sns.scatterplot(data=veri,x="serum_kolestrol",y="en_yuksek_kalp_hizi",hue="cinsiyet")
plt.show()
...
sns.lineplot(data=veri,x="yas",y="en_yuksek_kalp_hizi",hue="kalp_rahatsizligi")
plt.show()
...
# %%
sns.catplot(data=veri,x="gogus_agrisi_tipi",hue="kalp_rahatsizligi",col="aclik_kan_sekeri",kind="count")
